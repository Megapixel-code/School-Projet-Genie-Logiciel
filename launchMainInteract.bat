...
"C:\Program Files\Java\jdk-21\bin\java.exe" --module-path "..\School-Projet-Genie-Logiciel\javafx-sdk-17.0.15\lib" --add-modules javafx.controls,javafx.fxml -cp bin MainInteract
goto end
