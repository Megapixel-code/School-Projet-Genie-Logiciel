...
public class Labyrinthe {
    ...
    public LinkedList<Cellule> resoudre(String methode) {
        Solver solver;

        switch (methode.toUpperCase()) {
            case "BFS":
                solver = new BFSSolver(this);
                return solver.résoudreBFS();
            case "DFS":
                solver = new DFSSolver(this);
                return solver.résoudreDFS();
            default:
                System.out.println("Méthode de résolution inconnue : " + methode);
                return null;
        }
    }
